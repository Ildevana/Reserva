...
public class ClienteController implements Serializable {
    ...
    public String login() {
        try {
            current = getFacade().findByEmail(getSelected().getEmail());
            if(current.getSenha().equals(getSelected().getSenha())){
            ...
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("InvalidUser"));
            return null;
        }
    }
